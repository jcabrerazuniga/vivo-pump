...
class ReadUpdateDefTestCase(unittest.TestCase):
    ...
    def test_read_normal_def(self):
        ...
        print(update_def)
        self.assertTrue(list(update_def.keys()) == ['entity_def', 'column_defs'])
    ...
    def test_update_def_order(self):
        update_def = read_update_def('data/grant_def.json', prefix=QUERY_PARMS['prefix'])
        self.assertEqual(update_def['entity_def']['order'][0:4], ['deptid', 'direct_costs',
                                                                  'cois', 'end_date'])
...
class ReadCSVTestCase(unittest.TestCase):
    def test_read_csv_keys(self):
        ...
        print(data)
        self.assertTrue(list(data.keys()) == list(range(1, 74)))
...
class PumpGetTestCase(unittest.TestCase):
    ...
    def test_boolean_get(self):
        ...
        nfac = 0
        for row, vals in list(data.items()):
            if vals['faculty'] == '1':
                nfac += 1
...
class PumpUpdateCallTestCase(unittest.TestCase):
    ...
    def test_normal_inject(self):
        p = Pump()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n8984374104', 'abbreviation': 'None'}}
        p.update()
...
class MakeRdfTermFromSourceTestCase(unittest.TestCase):
    def test_empty(self):
        ...
        self.assertTrue(str(rdf_term) == str(Literal('')))
    ...
    def test_ref_string(self):
        ...
        source_val = 'http://any'
        rdf_term = make_rdf_term_from_source(source_val, step_def)
        self.assertTrue(str(rdf_term) == str(URIRef("http://any")))
...
class PumpUpdateLiteralsTestCase(unittest.TestCase):
    ...
    def test_add_unicode(self):
        ...
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n710', 'name': 'ქართული'}}
    ...
    def test_change_unicode(self):
        ...
        from testgraph import TestGraph
        p = Pump("data/person_def.json")
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n711', 'name': 'বিষ্ণুপ্রিয়া মণিপুরী'}}
        p.original_graph = TestGraph()
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_delete_unicode(self):
        ...
        from testgraph import TestGraph
        p = Pump("data/person_def.json")
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n711', 'name': 'None'}}
        p.original_graph = TestGraph()
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_change_with_datatype(self):
        ...
        from testgraph import TestGraph
        p = Pump("data/building_def.json")
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n1001011525', 'abbreviation': 'PH9'}}
        p.original_graph = TestGraph()
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_change_with_lang(self):
        ...
        from testgraph import TestGraph
        p = Pump("data/building_def.json")
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n1001011525', 'name': 'Building 42'}}
        p.original_graph = TestGraph()
        [add, sub] = p.update()
        self.assertTrue(
            len(add) == 1 and len(sub) == 1 and (URIRef("http://vivo.school.edu/individual/n1001011525"),
    ...
    def test_add_without_datatype(self):
        ...
        from testgraph import TestGraph
        p = Pump("data/building_def.json")
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n1001011525', 'url': 'http://a'}}
        p.original_graph = TestGraph()
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_change_without_lang(self):
        ...
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n2525', 'name': 'Ad ver tising'}}
        p.original_graph = TestGraph()
        [add, sub] = p.update()
        self.assertTrue(
...
class PumpUpdateTwoTestCase(unittest.TestCase):
    ...
    def test_blank_to_empty(self):
        ...
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n44',
                             'pis': ''}}
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_add_one_to_empty(self):
        ...
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n44',
                             'pis': 'http://vivo.school.edu/individual/n1133'}}
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_add_two_to_empty(self):
        ...
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n44',
                             'pis': 'http://vivo.school.edu/individual/n1133;http://vivo.school.edu/individual/n3413'}}
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_blank_to_two(self):
        ...
        p = Pump("data/grant_pi_def.json")
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n45',
                             'pis': ''}}
        [add, sub] = p.update()
        self.assertTrue(
            len(add) == 0 and len(sub) == 0)
    ...
    def test_add_one_new_to_two(self):
        ...
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n45',
                             'pis': 'http://vivo.school.edu/individual/n1134'}}
        [add, sub] = p.update()
        self.assertTrue(
...
class PumpUpdateDataTestCase(unittest.TestCase):
    def test_unique_one_add(self):
        ...
        p = Pump()
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n2525', 'abbreviation': 'PH9'}}
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_unique_one_change(self):
        ...
        p = Pump()
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n1001011525', 'abbreviation': 'JWR2'}}
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_unique_one_delete(self):
        ...
        p = Pump()
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n1001011525', 'abbreviation': 'None'}}
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_unique_two_add(self):
        ...
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n44', 'start_date': '2006'}}
        [add, sub] = p.update()
        self.assertTrue(
            len(add) == 3 and len(sub) == 0 and (URIRef("http://vivo.school.edu/individual/n44"),
    ...
    def test_unique_two_change(self):
        ...
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n125', 'end_date': '2006'}}
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_unique_two_delete(self):
        ...
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n125', 'end_date': 'None'}}
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_unique_three_add_fullpath(self):
        ...
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n2525', 'zip': '32653'}}
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_unique_three_add_to_existing(self):
        ...
        p = Pump("data/org_def.json")
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n3535', 'zip': '32653'}}
        [add, sub] = p.update()
        self.assertTrue(
            len(add) == 1 and len(sub) == 0 and (None,
                                                 URIRef("http://www.w3.org/2006/vcard/ns#postalCode"),
    ...
    def test_unique_three_change(self):
        ...
        p = Pump("data/org_def.json")
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n4545', 'zip': '32653'}}
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_unique_three_delete(self):
        ...
        p = Pump("data/org_def.json")
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n4545', 'zip': 'None'}}
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_unique_three_delete_not_found(self):
        ...
        p = Pump("data/org_def.json")
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n3535', 'zip': 'None'}}
        [add, sub] = p.update()
    ...
    def test_unique_three_add(self):
        ...
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n44', 'start_date': '2015-03-01'}}
        [add, sub] = p.update()
        self.assertTrue(
            len(add) == 5 and len(sub) == 0 and (None,
    ...
    def test_unique_three_add_partial_path(self):
        ...
        p = Pump("data/grant_def.json")
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n55', 'start_date': '2006-03-01'}}
        [add, sub] = p.update()
        self.assertTrue(
    ...
    def test_unique_three_change_datetime(self):
        ...
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n125', 'start_date': '2006-03-02'}}
        [add, sub] = p.update()
        self.assertTrue(
            len(add) == 1 and len(sub) == 1 and (None,
                                                 URIRef("http://vivoweb.org/ontology/core#dateTime"),
    ...
    def test_unique_three_delete_datetime(self):
        ...
        p = Pump("data/grant_def.json")
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n125', 'start_date': 'None'}}
        [add, sub] = p.update()
        self.assertTrue(
            len(add) == 0 and len(sub) == 1 and (None,
                                                 URIRef("http://vivoweb.org/ontology/core#dateTime"),
    ...
    def test_multiple_one_add(self):
        ...
        p = Pump("data/person_def.json")
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n1723097935',
                               'research_areas': 'http://vivo.school.edu/individual/n2551317090;http://vivo.school.edu/individual/n157098'}}
        p.original_graph = TestGraph()
    ...
    def test_multiple_one_delete(self):
        ...
        p = Pump("data/person_def.json")
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n25674',
                             'research_areas': 'None'}}
        [add, sub] = p.update()
...
class UpdateURITestCase(unittest.TestCase):
    def test_uri_not_found(self):
        ...
        p = Pump("data/person_def.json")
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n1723097936',
                             'types': 'fac;person'}}
        p.original_graph = TestGraph()
        [add, sub] = p.update()
...
class ClosureTestCase(unittest.TestCase):
    ...
    def test_normal_closure(self):
        ...
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': '',
                             'instructor': 'http://orcid.org/0000-0002-1305-8447',
...
class PumpMergeTestCase(unittest.TestCase):
    def test_show_merge(self):
        ...
        p = Pump("data/person_def.json")
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n25674', 'action': 'b'},
                         2: {'uri': 'http://vivo.school.edu/individual/n709', 'action': 'a1'},
                         3: {'uri': 'http://vivo.school.edu/individual/n710', 'action': ''},
                         4: {'uri': 'http://vivo.school.edu/individual/n1723097935', 'action': 'a1'},
                         5: {'uri': 'http://vivo.school.edu/individual/n2084211328', 'action': 'a'},
                         6: {'uri': 'http://vivo.school.edu/individual/n708', 'action': 'b1'},
                         7: {'uri': 'http://vivo.school.edu/individual/n711', 'action': 'a1'},
                         }
        [add, sub] = p.update()
    ...
    def test_no_primary_merge(self):
        ...
        p = Pump("data/person_def.json")
        p.original_graph = TestGraph()
        p.update_data = {3: {'uri': 'http://vivo.school.edu/individual/n710', 'action': ''},
                         4: {'uri': 'http://vivo.school.edu/individual/n1723097935', 'action': 'a1'},
                         7: {'uri': 'http://vivo.school.edu/individual/n711', 'action': 'a1'},
                         }
        [add, sub] = p.update()
    ...
    def test_no_secondary_merge(self):
        ...
        p.original_graph = TestGraph()
        p.update_data = {3: {'uri': 'http://vivo.school.edu/individual/n710', 'action': ''},
                         4: {'uri': 'http://vivo.school.edu/individual/n1723097935', 'action': 'a'},
                         7: {'uri': 'http://vivo.school.edu/individual/n711', 'action': 'a'},
                         }
        [add, sub] = p.update()
        self.assertTrue(len(add) == 0 and len(sub) == 0)
...
class PumpRemoveTestCase(unittest.TestCase):
    def test_uri_not_found_case(self):
        ...
        p = Pump("data/person_def.json")
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n20845',
                             'action': 'remove'}}
        [add, sub] = p.update()
        self.assertTrue(len(add) == 0 and len(sub) == 0)
    ...
    def test_single_uri_case(self):
        ...
        p = Pump("data/person_def.json")
        p.original_graph = TestGraph()
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n2084211328',
                             'action': 'Remove'}}
        [add, sub] = p.update()
    ...
    def test_not_found(self):
        ...
        p.update_data = {1: {'uri': 'http://vivo.school.edu/individual/n12345678',
                             'action': 'Remove'}}
        [add, sub] = p.update()
        self.assertTrue(len(add) == 0 and len(sub) == 0)
